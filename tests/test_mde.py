"""Contains tests for the MDEDevice class."""
...
def get_devices() -> list[MDEDevice]:
    ...
    -------
    list[MDEDevice]
        A list of "fake" devices used for testing.
...
def test_skip_device_cve():
    """Test of MDEDevice.should_skip method for CVE automation."""
    devices = get_devices()
...
def test_skip_device_ddc2():
    """Test of MDEDevice.should_skip method for DDC2 automation."""
    devices = get_devices()
...
def test_skip_device_ddc3():
    """Test of MDEDevice.should_skip method for DDC3 automation."""
    devices = get_devices()
